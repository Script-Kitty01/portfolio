...
export default function DomeGallery({
  ...
  const openItemFromElement = (el: HTMLElement) => {
    ...
    if (rawAlt) {
      ...
      label.className = "dg-skill-label";
      label.textContent = rawAlt;
      label.style.cssText =
        "position:absolute; left:0; right:0; bottom:0; padding:10px 12px; text-align:center; font-size:15px; font-weight:600; letter-spacing:0.3px; color:#ffffff; background:linear-gradient(180deg, rgba(0,0,0,0) 0%, rgba(0,0,0,0.75) 100%);";
