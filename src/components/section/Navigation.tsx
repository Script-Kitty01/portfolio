...
const Navigation = () => {
  ...
  return (
    ...
    >
      <div
        className="nav-container nav-pill"
        style={{
          borderRadius: "9999px",
          border: `1px solid ${isScrolled ? themeColors.navigation.borderScrolled : themeColors.navigation.border}`,
          boxShadow: `0 ${isScrolled ? "12px 36px" : "8px 28px"} ${isScrolled ? themeColors.navigation.shadowScrolled : themeColors.navigation.shadow}`,
          backdropFilter: "saturate(200%) blur(30px)",
          WebkitBackdropFilter: "saturate(200%) blur(30px)",
          transition: "all 0.3s ease",
          background: `linear-gradient(135deg,
            ${withAlpha(isDarkMode ? themeColors.colors.dark[950] : themeColors.colors.pink[50], isScrolled ? 0.85 : 0.65)},
            ${withAlpha(isDarkMode ? themeColors.colors.dark[900] : themeColors.colors.pink[25], isScrolled ? 0.85 : 0.65)})`,
        }}
      >
        <button
          ...
          aria-label="Aamira - Go to homepage"
        >
          Aamira
        </button>
        ...
        <div className="nav-tabs desktop-nav">
          ...
          <button
            ...
            style={{
              ...
              background: `linear-gradient(135deg, ${themeColors.colors.pink[400]}, ${themeColors.colors.pink[600]})`,
              boxShadow: `0 4px 14px ${withAlpha(themeColors.colors.pink[500], 0.4)}`,
            ...
            aria-label="Go to contact page to hire me"
          >
            Hire Me
          </button>
        </div>
